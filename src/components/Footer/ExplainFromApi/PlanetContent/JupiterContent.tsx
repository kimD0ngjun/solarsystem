...
const JupiterContent: React.FC<PlanetProps> = (props) => {
  ...
  return (
    <>
      <JupiterItem src={jupiter} alt="Jupiter" clickJupiter={clickJupiter} onClick={handleClickJupiter}/>
      <IoOrbit 
        speed={speed} 
        isPaused={isPaused} 
      ...
      >
        <IoItem src={io} alt="Io" clickIo={clickIo}/>
      </IoOrbit>
      <EuropaOrbit 
        speed={speed} 
        isPaused={isPaused} 
      ...
      >
        <EuropaItem src={europa} alt="europa" clickEuropa={clickEuropa}/>
      </EuropaOrbit>
      <GanymedeOrbit 
        speed={speed} 
        isPaused={isPaused} 
      ...
      >
        <GanymedeItem src={ganymede} alt="ganymede" clickGanymede={clickGanymede}/>
      </GanymedeOrbit>
      <CallistoOrbit 
        speed={speed} 
        isPaused={isPaused} 
      ...
      >
        <CallistoItem src={callisto} alt="callisto" clickCallisto={clickCallisto}/>
      </CallistoOrbit>
    </>
  )
}
