...
const UranusContent: React.FC<PlanetProps> = (props) => {
  ...
  return (
    <>
      <UranusItem src="/assets/PlanetImg/Uranus.svg" alt="Uranus" clickUranus={clickUranus} onClick={handleClickUranus}/>
      <TitaniaOrbit 
        speed={speed} 
        isPaused={isPaused} 
      ...
      >
        <TitaniaItem src="/assets/PlanetImg/Titania.svg" alt="Titania" clickTitania={clickTitania}/>
      </TitaniaOrbit>
    </>
  )
}
